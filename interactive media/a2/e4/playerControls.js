...
/* Full screen*/
/*Here, I used requestFullscreen() to put my video into fullscreen mode, and I also gave it a fullscreenchange event*/
...
document.addEventListener('fullscreenchange', (event) => {
  if (document.fullscreenElement) {
    console.log('enterFullscreen:', document.fullscreenElement);
  } else {
